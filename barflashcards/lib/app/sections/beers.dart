...
class BeersComponent extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BeersState();
}

class BeersState extends State {
        ...
        itemBuilder: (BuildContext context, int position) {
          return Card(
              ...
              child: ListTile(
                  ...
                  subtitle: new Text(this.beers[position].description == null ? "" : this.beers[position].description),
                  onTap: () {
